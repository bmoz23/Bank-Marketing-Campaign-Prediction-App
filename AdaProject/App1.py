...
lottie_animation_hello = load_lottie_file("hello.json")
lottie_animation_machine= load_lottie_file("machine.json")
feature_info = """
### Feature Information:
...
data= pd.read_csv("ADA_DATASET.csv")

# Page selection using sidebar
st.sidebar.title("Page Navigator")
page = st.sidebar.selectbox("Choose a page", ["Home", "Data Visualization", "Machine Learning Prediction Model"])
